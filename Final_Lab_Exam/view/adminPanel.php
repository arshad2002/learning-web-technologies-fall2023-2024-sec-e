...
<body>
    ...
    <header>
        ...
        <fieldset>
            ...
            <button type="button" onclick="searchEmployer()">Search</button>
        ...
        <div id="deleteUpdateButtons">
            <button type="button" onclick="deleteSelectedEmployer()">Delete Selected</button>
            <button type="button" onclick="updateSelectedEmployer()">Update Selected</button>
        </div>
